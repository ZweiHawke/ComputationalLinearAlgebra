#exec(open("rbradshaw_p1.py").read())

#exec(open("rbradshaw_p2.py").read())

#exec(open("rbradshaw_p3.py").read())

#exec(open("rbradshaw_p4.py").read())

#exec(open("rbradshaw_p6.py").read())
